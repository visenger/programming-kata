...
public class Lesson3 {
    ...
    static <T> void measureOneRun(String label, Supplier<T> supplier) {
        ...
        System.out.printf("%s took %dms%n",
                label, TimeUnit.NANOSECONDS.toMillis(endTime - startTime));
    }
...
//                System.getProperty("java.util.concurrent.ForkJoinPool.common.parallelism"));
        ...
        List<String> wordList = fullWordList.select(235887);

//        measure("Sequential", () -> computeSimilarity(wordList, false));
//        measure("Parallel", () -> computeSimilarity(wordList, true));
